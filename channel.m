classdef channel < handle
    ...
    methods
        ...
        function envelope(ch, windowSize)
            %enveloping
            [ch.rawEnveloped, lo]                       = envelope(ch.rawRectified, windowSize, "rms");
            [ch.filteredEnveloped, lo]                  = envelope(ch.filteredRectified, windowSize, "rms");
            [ch.signalRawLowBaselineEnveloped, lo]      = envelope(ch.signalRawLowBaselineRectified, windowSize, "rms");
            [ch.signalRawNoBaselineEnveloped, lo]       = envelope(ch.signalRawNoBaselineRectified, windowSize, "rms");
            [ch.signalFilteredLowBaselineEnveloped, lo] = envelope(ch.signalFilteredLowBaselineRectified, windowSize, "rms");
